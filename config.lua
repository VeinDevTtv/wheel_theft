...
Config.printLicensePlateToConsole = false
...
Config.jackSystem = {
   ['raise'] = {
       ...
       jobs = {
           'police',
           'ems',
           'bcso', -- Add your jobs here/Continue the list
       }
   },
   ['lower'] = {
...
Config.dispatch = {
    ...
    alertChance = 2, --- The chance of theft being notified to police members NOTE: The event gets called 4 times (once per each wheel) so set the chance to a relatively low number
...
Config.missionPeds = {
    ...
    ['mission_ped'] = {
        ...
        price = math.random(300, 500),
        blip = {
            showBlip = false, -- whether or not to show the location blip on the map
            blipColor = 28,
            blipIcon = 480,
