...
RegisterNetEvent('ls_wheel_theft:server:addItem')
AddEventHandler('ls_wheel_theft:server:addItem', function(item, amount)
    local _source = source
    GivePlayerItem(_source, item, amount or 1)
end)
